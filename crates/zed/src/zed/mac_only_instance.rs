...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Mizen Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Mizen Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Mizen Editor Preview Instance Running",
        ReleaseChannel::Stable => "Mizen Editor Stable Instance Running",
    }
}
